...
function formularioArabica() {
  ...
  if (estadoA == 8 || estadoA == 10 || estadoA == 11 || estadoA == 12 || estadoA == 23) {
    div_arabicaRiscos.style.height = '270px'
    ...
    if (hectaresA >= 3) {
      div_arabicaRiscos.style.height = '305px'
    ...
    div_arabicaRiscos.style.height = '270px'
    div_respostaArabica.innerHTML = `<p>De acordo com as informações de sua plantação, hoje, você pode estar <b>perdendo até 20% na produção, totalizando ${moedaP} anualmente</b>, pois, de acordo com o estado que você está localizado, a <b>má utilização</b> da água pode afetar uma parte considerável da produção.<br>
          O <b>uso eficiente da água</b> é uma ótima ideia, não?</p>`
  }
...
function formularioRobusta() {
  ...
  if (estadoR == 5 || estadoR == 7) {
    div_robustaRiscos.style.height = '260px'
    div_robustaResposta.innerHTML = `<p>De acordo com as informações de sua plantação, hoje, você pode estar <b>perdendo até 15% na produção, totalizando ${moedaR} anualmente</b>, pois, de acordo com o estado que você está localizado, a <b>crise hídrica</b> afeta uma parte considerável da produção.<br>
          O <b>uso eficiente da água</b> é uma ótima ideia, não?</p>`
    if (hectaresR >= 3) {
      div_robustaRiscos.style.height = '305px'
    ...
    div_robustaRiscos.style.height = '260px'
    div_robustaResposta.innerHTML = `<p>De acordo com as informações de sua plantação, hoje, você pode estar <b>perdendo entre 10 e 15% na produção, totalizando ${moedaRP} anualmente</b>, pois, de acordo com o estado que você está localizado, a <b>má utilização</b> da água pode afetar uma parte considerável da produção.<br>
          O <b>uso eficiente da água</b> é uma ótima ideia, não?</p>`
  }
}